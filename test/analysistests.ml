...
let liveness_analysis_tests =
  [ "programs/llvm_ir/analysis9.ll", lblm[
      "_entry", uids[]
      ; "body", uids["1"; "2"; "d0"; "d1"]
      ; "end", uids["1"]
      ; "guard", uids["1"; "2"; "d0"]
    ]
  ; "programs/llvm_ir/analysis8.ll", lblm[
      "_entry", uids[]
    ]
  ; "programs/llvm_ir/analysis7.ll", lblm[
      "_entry", uids[]
      ; "body", uids["1"; "4"]
      ; "end", uids["1"]
      ; "guard", uids["1"; "4"]
    ]
  ; "programs/llvm_ir/analysis5.ll", lblm[
      "_entry", uids[]
    ]
  ; "programs/llvm_ir/analysis4.ll", lblm[
      "_entry", uids["argc"]
      ; "l1", uids["2"; "3"]
      ; "l2", uids["3"]
    ]
  ; "programs/llvm_ir/analysis3.ll", lblm[
      "_entry", uids[]
      ; "l2", uids["1"]
      ; "l3", uids["2"]
      ; "l4", uids["3"]
  ...
  ; "programs/llvm_ir/analysis2.ll", lblm[
      "_entry", uids["argc"]
      ; "l1", uids["1"; "3"]
      ; "l2", uids[]
    ]
  ; "programs/llvm_ir/analysis19.ll", lblm[
      "_entry", uids[]
    ]
  ; "programs/llvm_ir/analysis18.ll", lblm[
      "_entry", uids[]
      ; "bar", uids["1"; "2"; "3"; "4"]
      ; "foo", uids["1"; "sa"]
    ]
  ; "programs/llvm_ir/analysis16.ll", lblm[
      "_entry", uids[]
  ...
  ; "programs/llvm_ir/analysis15.ll", lblm[
      "_entry", uids[]
    ]
  ; "programs/llvm_ir/analysis14.ll", lblm[
      "_entry", uids[]
    ]
  ; "programs/llvm_ir/analysis13.ll", lblm[
      "_entry", uids[]
      ; "correct", uids["7"]
      ; "five", uids["1"; "6"; "7"]
      ; "four", uids["1"; "5"; "6"; "7"]
  ...
  ; "programs/llvm_ir/analysis12.ll", lblm[
      "_entry", uids[]
    ]
  ; "programs/llvm_ir/analysis11.ll", lblm[
      "_entry", uids[]
      ; "foo", uids[]
    ]
  ; "programs/llvm_ir/analysis10.ll", lblm[
      "_entry", uids[]
      ; "else", uids["1"; "7"]
      ; "merge", uids["1"; "7"]
      ; "then", uids["1"; "7"]
    ]
  ; "programs/llvm_ir/analysis1.ll", lblm[
      "_entry", uids["argc"]
      ; "l1", uids["1"; "3"]
    ]
  ]
...
let constprop_analysis_tests =
  ...
  ; "programs/llvm_ir/analysis6.ll", lblm[
  ...
  ; "programs/llvm_ir/analysis17.ll", lblm[
